...
- Brownfield 2.7 activation lives in `guides/existing-apps.md`, `guides/ai-assistant-setup.md`, `reference/workflow-model.md`, `reference/project-health.md`, and `reference/command-surface.md`: `adopt`, `task`, `verify`, `codify`, analyze artifacts, theme inventory, task-time MCP/CLI context, visual manifest, baselines, local pattern proposals, and improved pattern discovery.
- `releases/`

...
| `@decantr/cli` | core-supported | `public-delivery` | stable | `delivery` (`30`) | `latest` | `true` | `true` | `0` | `stable-public` | Workflow commands for setup/adopt/task/verify/codify/content, local workflow/adoption policy resolution, adapter-backed bootstrap/attach, Brownfield intelligence, project-owned local patterns, registry sync, Evidence Bundles, visual manifests, health baselines, workspace health, Project Health CI and Studio, Content Health, and project governance. |

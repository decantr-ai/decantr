...
2. **Generated CSS files** - Theme tokens, visual treatments, and recipe decorators created by `decantr init`
...
import './styles/decorators.css';  // Generated by decantr init (recipe decorators)
```

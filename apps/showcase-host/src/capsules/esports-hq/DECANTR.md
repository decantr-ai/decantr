...
- **Theme:** gaming-guild (dark mode, rounded shape)
...
- **Sections:** 7 (team-operations [primary], scrim-scheduler [auxiliary], vod-review [auxiliary], sponsor-dashboard [auxiliary], marketing-esports [public], auth-full [gateway], settings-full [auxiliary])
- **Features:** team-management, rosters, scheduling, calendars, vod-review, annotations, sponsors, deals, marketing, auth, mfa, oauth, email-verification, password-reset, profile-edit, password-change, mfa-management, session-management, theme-toggle, account-deletion
- **Guard mode:** strict

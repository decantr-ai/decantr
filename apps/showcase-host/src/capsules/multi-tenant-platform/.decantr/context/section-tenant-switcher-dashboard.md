# Section: tenant-switcher-dashboard

**Role:** primary | **Shell:** sidebar-main | **Archetype:** tenant-switcher-dashboard
**Description:** Org-scoped dashboard with tenant switching, KPI overview, team management, and organization settings for multi-tenant SaaS platforms.

## Quick Start

**Shell:** Collapsible sidebar with header bar and scrollable main content area. Used by saas-dashboard, financial-dashboard, workbench, ecommerce (account pages). (nav: 240px, header: 52px)
**Pages:** 3 (overview, members, org-settings)
**Key patterns:** org-form [moderate]
...
multi-tenant, org-switcher, team-management, roles
...
Layout: kpis → activity → quick-actions

### members (/members)

Layout: members-table → permissions

### org-settings (/org-settings)

Layout: org-form → account

...
**Role:** auxiliary | **Shell:** sidebar-main | **Archetype:** audit-center
**Description:** Compliance audit trail with searchable event log, retention policies, export capabilities, and notification configuration for enterprise governance.

## Quick Start

**Shell:** Collapsible sidebar with header bar and scrollable main content area. Used by saas-dashboard, financial-dashboard, workbench, ecommerce (account pages). (nav: 240px, header: 52px)
**Pages:** 2 (audit-log, audit-settings)
**Key patterns:** settings-form [moderate]
...
audit-trail, compliance, export, retention
...
**Components:** Input, Textarea, Button, Label, Card, Toggle

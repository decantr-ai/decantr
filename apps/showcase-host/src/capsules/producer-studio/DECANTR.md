...
- **Theme:** studio-dark (dark mode, rounded shape)
...
- **Sections:** 7 (music-workspace [primary], track-library [auxiliary], collaboration-hub [auxiliary], session-rooms [auxiliary], marketing-producer [public], auth-full [gateway], settings-full [auxiliary])
- **Features:** session-editing, stems, mixing, track-management, versions, collaboration, royalties, live-sessions, voice-chat, marketing, auth, mfa, oauth, email-verification, password-reset, profile-edit, password-change, mfa-management, session-management, theme-toggle, account-deletion
- **Guard mode:** strict

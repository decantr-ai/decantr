...
export const contentItems: ContentItem[] = [
  ...
  { id: '2', type: 'pattern', name: 'Search Filter Bar', slug: 'search-filter-bar', namespace: '@official', description: 'Search input with type and namespace dropdown filters for browsing catalog content.', version: '1.8.0', downloads: 9432, updatedAt: '2026-03-28', author: 'decantr' },

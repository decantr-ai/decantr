...
**Role:** auxiliary | **Shell:** recipefork-top-nav | **Archetype:** recipefork-cookbooks
...
**Pages:** 2 (cookbooks, cookbook-detail)
**Key patterns:** card-grid [moderate], cta-section, hero
**Density:** comfortable
...
**Theme decorators:** 6 `recipefork-*` classes — full Class/Intent/Apply-to table in `section-recipefork-cookbooks-pack.md` (preferred) and DECANTR.md "Decorator Quick Reference". MUST apply.
...
collections, visibility, recipe-saving
...
Layout: card-grid (collection) → cta-section (compact)

### cookbook-detail (/cookbooks/:id)

Layout: hero (image-overlay) → card-grid (content)

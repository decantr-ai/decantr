...
**Role:** auxiliary | **Shell:** recipefork-top-nav | **Archetype:** recipefork-social
...
**Pages:** 1 (feed)
**Key patterns:** filter-bar [moderate], card-grid [moderate], recipefork-activity-feed [moderate]
**Density:** comfortable
...
**Theme decorators:** 6 `recipefork-*` classes — full Class/Intent/Apply-to table in `section-recipefork-social-pack.md` (preferred) and DECANTR.md "Decorator Quick Reference". MUST apply.
...
social, activity-feed, comments, reactions, follows, forking, engagement-ranking, lineage-cues
...
Layout: filter-bar (standard) → card-grid (content) → recipefork-activity-feed (preview-cards)

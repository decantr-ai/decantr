...
const quotes = [
  { body: 'Recipefork turned my Sunday cooking into a ritual I actually share.', author: 'Nora H.', role: 'Home cook · Osaka' },
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1.1fr 1fr', gap: '3rem', alignItems: 'center' }} className="hero-grid">
          <div className={css('_flex _col _gap4')}>
            ...
            <p style={{ fontSize: '1.125rem', color: 'var(--d-text-muted)', lineHeight: 1.6, maxWidth: 520 }}>
              Recipefork is a recipe community built around beautiful photography, real kitchens, and the cooks
            ...
            <div className={css('_flex _aic _gap6')} style={{ marginTop: '1rem' }}>
              ...
              <div>
                ...
                <div className={css('_textsm')} style={{ color: 'var(--d-text-muted)' }}>Cookbooks</div>
              </div>
            </div>
          </div>

...
**Role:** primary | **Shell:** sidebar-main | **Archetype:** admin-overview
**Description:** Store operations dashboard with KPIs, sales charts, activity feed, and quick action cards. Central hub for e-commerce administrators.

## Quick Start

**Shell:** Collapsible sidebar with header bar and scrollable main content area. Used by saas-dashboard, financial-dashboard, workbench, ecommerce (account pages). (nav: 240px, header: 52px)
**Pages:** 2 (dashboard, quick-actions)
...
analytics-state, notifications, quick-actions
...
Layout: store-kpis → sales-charts → recent-activity

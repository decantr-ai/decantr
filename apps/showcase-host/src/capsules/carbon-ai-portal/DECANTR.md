...
- **Theme:** carbon (dark mode, rounded shape)
...
- **Sections:** 7 (ai-chatbot [primary], auth-full [gateway], settings-full [auxiliary], marketing-saas [public], about-hybrid [public], contact [public], legal [public])
- **Features:** chat, markdown, code-highlight, file-upload, mentions, reactions, export, auth, mfa, oauth, email-verification, password-reset, profile-edit, password-change, mfa-management, session-management, theme-toggle, account-deletion, pricing-toggle, testimonials, feature-grid, team-grid, values-display, form-validation, spam-protection, file-attachment, toc-navigation, print-friendly, smooth-scroll
- **Guard mode:** strict

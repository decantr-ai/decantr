# Section: marketing-recipe

**Role:** public | **Shell:** top-nav-footer | **Archetype:** marketing-recipe
**Description:** Public marketing landing page for the recipe community platform with hero, featured recipes, testimonials, and conversion CTAs.
...
**Pages:** 1 (home)
**Key patterns:** landing-hero, featured-recipes, join-cta
...
Layout: landing-hero → featured-recipes → community-quotes → join-cta

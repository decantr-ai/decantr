...
- **Sections:** 3 (spatial-workspace [primary], auth-full [gateway], about-hybrid [public])
- **Features:** spatial, collaboration, drag-drop, real-time, presence, auth, mfa, oauth, email-verification, password-reset, team-grid, values-display, theme-toggle
- **Guard mode:** strict

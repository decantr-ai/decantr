...
**Role:** auxiliary | **Shell:** sidebar-main | **Archetype:** inventory-supplies
**Description:** Restaurant inventory and purchasing workspace. Tracks ingredients, par levels, usage, and purchase orders across suppliers.

## Quick Start

**Shell:** Collapsible sidebar with header bar and scrollable main content area. Used by saas-dashboard, financial-dashboard, workbench, ecommerce (account pages). (nav: 240px, header: 52px)
**Pages:** 3 (inventory, ingredient-detail, orders)
...
Layout: par-levels → ingredient-list

### ingredient-detail (/inventory/:id)

Layout: ingredient-header → usage-charts

### orders (/inventory/orders)

Layout: po-board → po-list

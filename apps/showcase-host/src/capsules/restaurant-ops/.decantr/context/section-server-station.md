# Section: server-station

**Role:** auxiliary | **Shell:** sidebar-main | **Archetype:** server-station
**Description:** Server-facing shift workspace. Tracks active tables, shift performance, sales, and tips across the current shift.

## Quick Start

**Shell:** Collapsible sidebar with header bar and scrollable main content area. Used by saas-dashboard, financial-dashboard, workbench, ecommerce (account pages). (nav: 240px, header: 52px)
**Pages:** 2 (shift, tips)
**Key patterns:** tip-history
...
Layout: shift-kpis → shift-activity

### tips (/shift/tips)

Layout: tip-charts → tip-history

...
**Role:** auxiliary | **Shell:** sidebar-main | **Archetype:** menu-management
**Description:** Menu editor and engineering workspace. Manages menus, sections, items, pricing, modifiers, and profitability analysis.

## Quick Start

**Shell:** Collapsible sidebar with header bar and scrollable main content area. Used by saas-dashboard, financial-dashboard, workbench, ecommerce (account pages). (nav: 240px, header: 52px)
**Pages:** 3 (menus, menu-detail, menu-engineering)
...
Layout: menu-list → menu-cards

### menu-detail (/menus/:id)

Layout: menu-editor → item-order

### menu-engineering (/menus/engineering)

Layout: profit-charts → item-matrix

...
- **Sections:** 5 (portfolio-showcase [primary], portfolio-about [auxiliary], portfolio-blog [auxiliary], auth-flow [gateway], settings [auxiliary])
- **Features:** gallery, lightbox, lazy-loading, contact-form, social-links, markdown, syntax-highlight, reading-time, auth
- **Guard mode:** strict

...
**Role:** auxiliary | **Shell:** sidebar-main | **Archetype:** service-requests
**Description:** Citizen service request system with submission forms, map pin placement, kanban tracking, and status timelines. Enables residents to report issues and track resolution.

## Quick Start

**Shell:** Collapsible sidebar with header bar and scrollable main content area. Used by saas-dashboard, financial-dashboard, workbench, ecommerce (account pages). (nav: 240px, header: 52px)
**Pages:** 3 (requests, new-request, request-detail)
**Key patterns:** request-form [moderate]
...
Layout: request-table → request-board

### new-request (/requests/new)

Layout: request-form → location-picker

### request-detail (/requests/:id)

Layout: request-header → status-timeline

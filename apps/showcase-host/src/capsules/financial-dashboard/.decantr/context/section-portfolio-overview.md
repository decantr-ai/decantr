...
**Role:** primary | **Shell:** sidebar-main | **Archetype:** portfolio-overview
**Description:** Financial portfolio dashboard with net worth KPIs, allocation charts, and asset data tables. Primary view for wealth management and investment tracking.

## Quick Start

**Shell:** Collapsible sidebar with header bar and scrollable main content area. Used by saas-dashboard, financial-dashboard, workbench, ecommerce (account pages). (nav: 240px, header: 52px)
**Pages:** 2 (overview, allocations)
**Key patterns:** performance-charts [moderate]
...
Layout: portfolio-kpis → performance-charts

### allocations (/allocations)

Layout: allocation-charts → allocation-table

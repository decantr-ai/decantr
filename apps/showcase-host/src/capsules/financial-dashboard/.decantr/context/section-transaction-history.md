...
**Role:** auxiliary | **Shell:** sidebar-main | **Archetype:** transaction-history
**Description:** Financial transaction ledger with filterable data tables, sparkline trend indicators, and transaction detail views.

## Quick Start

**Shell:** Collapsible sidebar with header bar and scrollable main content area. Used by saas-dashboard, financial-dashboard, workbench, ecommerce (account pages). (nav: 240px, header: 52px)
**Pages:** 2 (transactions, transaction-detail)
...
Layout: transaction-filters → transaction-table → trend-sparklines

### transaction-detail (/transactions/:id)

Layout: transaction-header

...
- **Theme:** auradecantism (dark mode, rounded shape)
...
- **Sections:** 7 (portfolio-overview [primary], transaction-history [auxiliary], budget-planner [auxiliary], investment-tracker [auxiliary], marketing-finance [public], auth-full [gateway], settings-full [auxiliary])
- **Features:** analytics-state, data-export, filtering, search, real-time-data, marketing, seo, auth, mfa, oauth, email-verification, password-reset, profile-edit, password-change, mfa-management, session-management, theme-toggle, account-deletion, command-palette
- **Guard mode:** strict

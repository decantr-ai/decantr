...
- **Sections:** 7 (doc-browser [primary], search-hub [auxiliary], changelog-center [auxiliary], api-reference [auxiliary], marketing-docs [public], auth-flow [gateway], settings [auxiliary])
- **Features:** docs, navigation, table-of-contents, breadcrumbs, ai-search, semantic-search, highlighting, changelog, versions, migration-guides, api-docs, try-it-out, code-snippets, marketing, seo, auth, theme-toggle
- **Guard mode:** strict

...
- **Sections:** 5 (copilot-workspace [primary], copilot-settings [auxiliary], marketing-copilot [public], auth-flow [gateway], settings [auxiliary])
- **Features:** copilot, ai-suggestions, context-awareness, keyboard-shortcuts, settings, model-config, permissions, marketing, demo, seo, auth, command-palette
- **Guard mode:** strict

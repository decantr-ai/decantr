...
**Role:** auxiliary | **Shell:** sidebar-main | **Archetype:** render-monitor
**Description:** Observe every render job in flight: queue, progress, GPU utilization, and live log streaming for diagnosing failed or slow video generations.

## Quick Start

**Shell:** Collapsible sidebar with header bar and scrollable main content area. Used by saas-dashboard, financial-dashboard, workbench, ecommerce (account pages). (nav: 240px, header: 52px)
**Pages:** 2 (renders, render-detail)
...
Layout: filters → queue-list

### render-detail (/renders/:id)

Layout: job-header → live-logs

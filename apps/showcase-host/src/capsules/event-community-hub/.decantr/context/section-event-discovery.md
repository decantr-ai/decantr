# Section: event-discovery

**Role:** primary | **Shell:** top-nav-main | **Archetype:** event-discovery
**Description:** Event browsing and discovery interface with search, calendar, map, and detail views. Core exploration surface for event and community platforms.
...
**Pages:** 2 (events, event-detail)
**Key patterns:** event-hero
...
events, search, calendar, map, filters
...
Layout: search-filters → event-cards → calendar → map

### event-detail (/events/:id)

Layout: event-hero → schedule → related-events

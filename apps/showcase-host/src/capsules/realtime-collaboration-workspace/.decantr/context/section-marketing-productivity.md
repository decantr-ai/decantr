# Section: marketing-productivity

**Role:** public | **Shell:** top-nav-footer | **Archetype:** marketing-productivity
**Description:** Marketing landing page for productivity and collaboration tools. Features hero, feature grid, collaboration showcase, pricing, and testimonials.
...
**Key patterns:** hero, features, pricing [moderate], testimonials [moderate], cta
...
marketing, pricing, testimonials, cta
...
Layout: hero → features → collaboration-demo → pricing → testimonials → cta

### pricing (/pricing)

Layout: hero → pricing → cta

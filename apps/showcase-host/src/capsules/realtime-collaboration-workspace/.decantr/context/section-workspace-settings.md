...
**Role:** auxiliary | **Shell:** sidebar-main | **Archetype:** workspace-settings
**Description:** Team workspace configuration including general settings, member management, permissions, and billing.

## Quick Start

**Shell:** Collapsible sidebar with header bar and scrollable main content area. Used by saas-dashboard, financial-dashboard, workbench, ecommerce (account pages). (nav: 240px, header: 52px)
**Pages:** 4 (general, members, permissions, billing)
**Key patterns:** data-table [moderate]
...
team-management, permissions, billing, admin
...
Layout: workspace-info

### members (/settings/members)

Layout: data-table → invite

...
**Role:** auxiliary | **Shell:** sidebar-main | **Archetype:** seller-dashboard
**Description:** Seller management hub with listing management, performance analytics, earnings tracking, and review monitoring for marketplace sellers.

## Quick Start

**Shell:** Collapsible sidebar with header bar and scrollable main content area. Used by saas-dashboard, financial-dashboard, workbench, ecommerce (account pages). (nav: 240px, header: 52px)
**Pages:** 5 (seller-overview, seller-listings, seller-listing-edit, seller-analytics, seller-reviews)
**Key patterns:** listing-form [moderate]
...
listings, analytics, earnings, reviews
...
Layout: metrics → recent-activity

### seller-listings (/seller/listings)

Layout: listings-table

### seller-listing-edit (/seller/listings/:id/edit)

Layout: listing-form

### seller-analytics (/seller/analytics)

Layout: summary-kpis → charts → trends

### seller-reviews (/seller/reviews)

Layout: reviews-table

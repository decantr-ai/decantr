    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem', textAlign: 'center' }}>
      ...
      <div>
        ...
        <p style={{ color: 'var(--d-text-muted)', fontSize: '0.875rem' }}>
          We sent a verification link. Click it to confirm your address.
        </p>
      </div>
      <button className="nm-button-primary" onClick={() => navigate('/browse')} style={{ width: '100%', padding: '0.75rem' }}>

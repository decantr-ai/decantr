...
export function DangerSettingsPage() {
  return (
    <SettingsLayout title="Danger zone" description="Actions that affect your account permanently.">
      <section className="nm-card" style={{ padding: 0 }}>
        <div style={{ padding: '1.25rem 1.5rem', borderBottom: '1px solid var(--d-border)' }}>
          ...
          <p style={{ fontSize: '0.85rem', color: 'var(--d-text-muted)', marginTop: '0.25rem' }}>
            Download a copy of your trips, listings, messages, and reviews.
          </p>
        </div>
      ...
      <section className="nm-card" style={{ padding: 0, borderColor: 'color-mix(in srgb, var(--d-error) 30%, var(--d-border))' }}>
        <div style={{ padding: '1.25rem 1.5rem', borderBottom: '1px solid var(--d-border)', display: 'flex', gap: '0.75rem', alignItems: 'flex-start' }}>
          ...
          <div>
            ...
            <p style={{ fontSize: '0.85rem', color: 'var(--d-text-muted)', marginTop: '0.25rem' }}>
              Permanently delete your Nestable account, bookings, listings, and reviews. This cannot be undone.
            </p>
          </div>
        </div>
        <div style={{ padding: '1rem 1.5rem', display: 'flex', justifyContent: 'flex-end' }}>
          <button className="d-interactive" data-variant="danger" style={{ background: 'var(--d-error)', color: '#fff', borderColor: 'var(--d-error)' }}>
            Delete my account
          </button>
        </div>
      </section>

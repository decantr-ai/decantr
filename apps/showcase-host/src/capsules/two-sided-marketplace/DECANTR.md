...
- **Theme:** clean (light mode, rounded shape)
...
- **Sections:** 8 (listing-browser [primary], buyer-dashboard [auxiliary], seller-dashboard [auxiliary], marketplace-messaging [auxiliary], review-system [auxiliary], marketing-marketplace [public], auth-full [gateway], settings-full [auxiliary])
- **Features:** search, filters, map-view, image-gallery, bookings, favorites, messaging, listings, analytics, earnings, reviews, contextual-listing-cards, ratings, photos, marketing, seo, featured-listings, auth, mfa, oauth, email-verification, password-reset, profile-edit, password-change, mfa-management, session-management, theme-toggle, account-deletion
- **Guard mode:** strict

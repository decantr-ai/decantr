...
- **Theme:** retro-arcade (dark mode, sharp shape)
...
- **Sections:** 1 (launch-campaign [public])
...
|-------|--------|----------|---------|
| `.arcade-canvas` | Use on page roots and full-bleed sections. The canvas should feel immersive while preserving a centered campaign safe area. | Page roots, Full-bleed campaign bands, Launch homepages | background-color: #100B2D; background-image: linear-gradient(rgba(255,255,255,0.035) 1px, transparent 1px); background-size: 100% 4px; color: #FFF6D6; min-height: 100vh |
| `.arcade-marquee` | Use for hero headlines, section titles, and primary campaign identity. The marquee must be a dominant visual signal. | Hero labels, Section headers, Campaign status bands | border: 4px solid #FFF6D6; background: #FF2E63; color: #FFF6D6; font-family: 'Press Start 2P', 'Space Grotesk', ui-sans-serif, sans-serif; text-transform: uppercase; letter-spacing: 0 |
| `.arcade-bezel` | Use for product demos, progress consoles, and pledge modules. The bezel replaces generic cards. | Demo screens, Progress modules, Campaign panels | background: #17113D; border: 5px solid #FFF6D6; box-shadow: inset 0 0 0 3px #00E5FF; border-radius: 6px; padding: 24px |
| `.arcade-button` | Use for all primary and secondary actions. Buttons should look physical and tappable. | Primary CTAs, Reward selection, Checkout actions, Share buttons | background: #FFE156; color: #18112F; border: 3px solid #18112F; border-radius: 999px; box-shadow: 4px 4px 0 #18112F; font-weight: 800; transition: transform 90ms ease-out, box-shadow 90ms ease-out |
| `.arcade-token` | Use for compact status, backer levels, limited-run labels, and pledge tokens. | Badges, Backer counts, Tier markers, Campaign state chips | border: 3px double #18112F; border-radius: 999px; background: #FFE156; color: #18112F; font-weight: 800; text-transform: uppercase |
| `.arcade-led-counter` | Use for funding totals, countdowns, backer counts, and reward inventory. Numbers must be highly legible. | Metric strips, Counters, Campaign timers, Funding totals | background: #060417; color: #00E5FF; border: 2px solid #FFE156; font-family: 'IBM Plex Mono', ui-monospace, monospace; font-variant-numeric: tabular-nums; padding: 8px 12px |
| `.arcade-pixel-border` | Use when a section needs retro structure without becoming another card. | Spec panels, Manual surfaces, Tier rows, Story panels | border: 4px solid #18112F; box-shadow: inset 0 0 0 2px #FFF6D6; border-radius: 0; background: #FFFDF2 |
| `.arcade-progress-track` | Use for funding, stretch goals, tier availability, and onboarding completion. Progress should feel like campaign momentum. | Funding progress, Stretch goals, Inventory meters, Referral progress | height: 18px; border: 3px solid #FFF6D6; background: repeating-linear-gradient(90deg, #24185C 0 16px, #17113D 16px 20px); border-radius: 999px; overflow: hidden |
| `.arcade-manual-panel` | Use for explanatory sections, product specs, story steps, and launch instructions. This replaces generic marketing cards. | Product specs, How-it-works sections, Founder story, FAQ/manual content | background: #FFFDF2; color: #18112F; border: 3px solid #18112F; border-radius: 6px; padding: 24px |
| `.arcade-sticker` | Use sparingly for limited-run notes, shipping states, early-bird labels, and proof cues. | Limited labels, Launch notes, Inventory tags, Proof badges | background: #00E5FF; color: #18112F; border: 2px solid #18112F; border-radius: 4px; padding: 4px 10px; font-weight: 800; text-transform: uppercase; transform: rotate(-2deg) |

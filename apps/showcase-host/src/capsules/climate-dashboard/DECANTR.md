...
- **Theme:** earth (light mode, rounded shape)
...
- **Sections:** 7 (emissions-dashboard [primary], supply-chain [auxiliary], offset-marketplace [auxiliary], reporting-center [auxiliary], marketing-climate [public], auth-full [gateway], settings-full [auxiliary])
- **Features:** emissions-tracking, scope-123, targets, supply-chain, tier-tracking, offsets, marketplace, purchasing, reporting, csrd, compliance, marketing, auth, mfa, oauth, email-verification, password-reset, profile-edit, password-change, mfa-management, session-management, theme-toggle, account-deletion
- **Guard mode:** strict

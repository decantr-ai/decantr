...
"carbon-neon". This would violate the Style guard rule.

Would you like me to:
1. Update the essence to use "glassmorphism" instead?
2. Keep the current theme "carbon-neon"?
```
...
- [ ] I know the exact layout order: `agent-swarm-canvas as swarm-topology, agent-timeline as activity-feed`
- [ ] I will use theme: `carbon-neon`
- [ ] I will use theme: `carbon-neon`
...
|-----------|---------------|-----|
| "Theme mismatch" | Used different theme | Revert to `carbon-neon` |
...
| "Theme mismatch" | Wrong decoration style | Use `carbon-neon` |

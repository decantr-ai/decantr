...
- **Sections:** 5 (workbench-core [primary], workbench-catalog [auxiliary], workbench-inspector [auxiliary], auth-flow [gateway], settings [auxiliary])
- **Features:** keyboard-shortcuts, split-pane, command-palette, search, filtering, live-preview, editing, auth, theme-toggle
- **Guard mode:** strict

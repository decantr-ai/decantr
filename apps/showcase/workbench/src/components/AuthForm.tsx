...
import { Hexagon, Github, Chrome } from 'lucide-react';
...
const config = {
  login: {
    title: 'Welcome back',
    subtitle: 'Sign in to the workbench',
    submitLabel: 'Sign In',
  ...
  register: {
    ...
    subtitle: 'Get started with the design workbench',
  ...
  return (
    <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 'var(--d-content-gap)' }}>
      ...
      <div style={{ textAlign: 'center', marginBottom: '0.5rem' }}>
        <Hexagon size={32} style={{ color: 'var(--d-primary)', margin: '0 auto 0.75rem' }} />
      ...
      {c.showOAuth && (
        <>
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
            <hr className="d-divider" style={{ flex: 1 }} />

...
- **Theme:** counsel (light mode, rounded shape)
...
- **Sections:** 7 (research-workspace [primary], contract-center [auxiliary], matter-management [auxiliary], citation-tools [auxiliary], marketing-legal [public], auth-full [gateway], settings-full [auxiliary])
- **Features:** case-law, citations, research, contracts, redlining, diffs, matters, billing-tracking, shepardize, marketing, auth, mfa, oauth, email-verification, password-reset, profile-edit, password-change, mfa-management, session-management, theme-toggle, account-deletion
- **Guard mode:** strict

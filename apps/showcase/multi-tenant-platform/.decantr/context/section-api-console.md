...
**Role:** auxiliary | **Shell:** sidebar-main | **Archetype:** api-console
**Description:** Interactive API documentation, key management, and webhook configuration console for developer-facing SaaS platforms.

## Quick Start

**Shell:** Collapsible sidebar with header bar and scrollable main content area. Used by saas-dashboard, financial-dashboard, workbench, ecommerce (account pages). (nav: 240px, header: 52px)
**Pages:** 3 (api-docs, api-keys, webhooks)
...
api-console, api-keys, webhooks, documentation
...
Layout: webhooks-table → debugger

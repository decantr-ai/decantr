...
**Role:** auxiliary | **Shell:** sidebar-main | **Archetype:** usage-billing
**Description:** Usage metering dashboard, plan management, payment configuration, and invoice history for consumption-based SaaS billing.

## Quick Start

**Shell:** Collapsible sidebar with header bar and scrollable main content area. Used by saas-dashboard, financial-dashboard, workbench, ecommerce (account pages). (nav: 240px, header: 52px)
**Pages:** 3 (usage, billing, invoices)
**Key patterns:** payment-form [moderate]
...
billing, usage-metering, invoices, plans
...
Layout: meters → charts → usage-details

### billing (/billing)

Layout: plan-selector → payment-form → recent-payments

### invoices (/invoices)

Layout: invoices-table

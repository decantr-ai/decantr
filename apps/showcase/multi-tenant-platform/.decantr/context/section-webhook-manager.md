# Section: webhook-manager

**Role:** auxiliary | **Shell:** sidebar-main | **Archetype:** webhook-manager
**Description:** Webhook endpoint configuration, event filtering, delivery monitoring, and retry management for platform integrations.

## Quick Start

**Shell:** Collapsible sidebar with header bar and scrollable main content area. Used by saas-dashboard, financial-dashboard, workbench, ecommerce (account pages). (nav: 240px, header: 52px)
**Pages:** 2 (endpoints, endpoint-detail)
...
webhooks, event-filtering, retry-logic
...
Layout: endpoints-table

### endpoint-detail (/webhooks/:id)

Layout: endpoint-config → delivery-log

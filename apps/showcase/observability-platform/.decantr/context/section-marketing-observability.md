# Section: marketing-observability

**Role:** public | **Shell:** top-nav-footer | **Archetype:** marketing-observability
**Description:** Public marketing landing page for the observability platform. Showcases product vision, feature highlights, pricing tiers, testimonials, and call-to-action sections.
...
**Pages:** 1 (home)
**Key patterns:** hero, features, pricing [moderate], testimonials [moderate], cta-section
...
Layout: hero → features → pricing → testimonials → cta-section

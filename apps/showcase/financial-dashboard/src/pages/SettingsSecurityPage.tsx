    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem', maxWidth: '42rem' }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
        ...
        <form onSubmit={e => e.preventDefault()} className="d-surface" style={{ padding: 'var(--d-surface-p)' }}>
          ...
          <p style={{ fontSize: '0.8rem', color: 'var(--d-text-muted)', marginBottom: '1rem' }}>Use at least 14 characters. Financial accounts require extra care.</p>
          ...
          <button className="fd-button-accent" type="submit" style={{ padding: '0.375rem 0.875rem', fontSize: '0.8rem' }}>Update password</button>
        </form>
          ...
          <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', gap: '1rem' }}>
            <div style={{ flex: 1 }}>
              ...
              <p style={{ fontSize: '0.8rem', color: 'var(--d-text-muted)' }}>
                ...
                Authenticator app · 10 backup codes remaining
              </p>
            </div>

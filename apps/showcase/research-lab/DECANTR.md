...
- **Theme:** lab (light mode, sharp shape)
...
- **Sections:** 8 (lab-notebook [primary], experiment-tracker [auxiliary], sample-inventory [auxiliary], instrument-booking [auxiliary], data-repository [auxiliary], marketing-research [public], auth-full [gateway], settings-full [auxiliary])
- **Features:** notebook, entries, authoring, protocols, experiments, tracking, samples, chain-of-custody, inventory, booking, scheduling, instruments, datasets, repository, data-catalog, marketing, landing, about, auth, mfa, oauth, email-verification, password-reset, profile-edit, password-change, mfa-management, session-management, theme-toggle, account-deletion
- **Guard mode:** strict

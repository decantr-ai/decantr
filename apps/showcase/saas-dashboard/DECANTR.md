...
- **Sections:** 7 (saas-overview [primary], team-workspace [auxiliary], saas-analytics [auxiliary], saas-billing-v2 [auxiliary], marketing-saas-v2 [public], auth-full [gateway], settings-full [auxiliary])
- **Features:** real-time, charts, kpi, activity-feed, invite, roles, permissions, search, export, date-range, billing, invoices, usage-tracking, marketing, seo, conversion, auth, mfa, oauth, email-verification, password-reset, profile-edit, password-change, mfa-management, session-management, theme-toggle, account-deletion, command-palette
- **Guard mode:** strict

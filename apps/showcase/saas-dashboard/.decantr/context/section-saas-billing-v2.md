# Section: saas-billing-v2

**Role:** auxiliary | **Shell:** sidebar-main | **Archetype:** saas-billing-v2
**Description:** Billing management with plan selection, usage meters, invoice history, and payment management for SaaS products.

## Quick Start

**Shell:** Collapsible sidebar with header bar and scrollable main content area. Used by saas-dashboard, financial-dashboard, workbench, ecommerce (account pages). (nav: 240px, header: 52px)
**Pages:** 2 (billing, invoices)
...
billing, invoices, usage-tracking
...
Layout: plan-selector → usage-bar

### invoices (/billing/invoices)

Layout: invoice-table → payments

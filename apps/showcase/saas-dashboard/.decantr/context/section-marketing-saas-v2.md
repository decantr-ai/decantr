# Section: marketing-saas-v2

**Role:** public | **Shell:** top-nav-footer | **Archetype:** marketing-saas-v2
**Description:** Public marketing landing page for SaaS products with hero, features, pricing, testimonials, and conversion CTAs.
...
**Pages:** 1 (home)
**Key patterns:** landing-hero, feature-grid, pricing-tiers, bottom-cta
...
Layout: landing-hero → feature-grid → pricing-tiers → social-proof → bottom-cta

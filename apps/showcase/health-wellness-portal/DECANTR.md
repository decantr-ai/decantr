...
- **Theme:** healthcare (light mode, rounded shape)
...
- **Sections:** 7 (patient-dashboard [primary], appointment-center [auxiliary], telehealth-room [auxiliary], health-records [auxiliary], marketing-health [public], auth-full [gateway], settings-full [auxiliary])
- **Features:** vitals, medications, appointments, health-records, booking, telehealth, video, notes, records, documents, intake-forms, marketing, seo, auth, mfa, oauth, email-verification, password-reset, profile-edit, password-change, mfa-management, session-management, theme-toggle, account-deletion
- **Guard mode:** strict

...
**Role:** auxiliary | **Shell:** sidebar-main | **Archetype:** order-fulfillment
**Description:** Admin order processing and shipping management with data tables, Kanban pipeline boards, order detail views, and fulfillment action forms.

## Quick Start

**Shell:** Collapsible sidebar with header bar and scrollable main content area. Used by saas-dashboard, financial-dashboard, workbench, ecommerce (account pages). (nav: 240px, header: 52px)
**Pages:** 2 (orders, order-detail)
**Key patterns:** fulfillment-form [moderate]
...
order-tracking, bulk-actions, notifications
...
Layout: order-table → fulfillment-board

### order-detail (/orders/:id)

Layout: order-header → order-timeline → fulfillment-form

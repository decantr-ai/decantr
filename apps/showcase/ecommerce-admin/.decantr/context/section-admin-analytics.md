...
**Role:** auxiliary | **Shell:** sidebar-main | **Archetype:** admin-analytics
**Description:** Revenue and sales analytics for e-commerce administrators with KPI dashboards, trend charts, and inline sparkline data tables.
...
analytics-state, data-export, date-range-picker
...
Layout: revenue-kpis → analytics-charts → trend-sparklines

...
**Role:** auxiliary | **Shell:** sidebar-main | **Archetype:** product-management
**Description:** Product catalog CRUD and inventory management with data tables, edit forms, and Kanban-style inventory boards for e-commerce admin operations.

## Quick Start

**Shell:** Collapsible sidebar with header bar and scrollable main content area. Used by saas-dashboard, financial-dashboard, workbench, ecommerce (account pages). (nav: 240px, header: 52px)
**Pages:** 3 (products, product-edit, inventory)
**Key patterns:** product-form [moderate]
...
bulk-actions, search, inline-editing, image-upload
...
Layout: stock-table → stock-board

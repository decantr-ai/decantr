...
- **Theme:** glassmorphism (dark mode, rounded shape)
...
- **Sections:** 7 (crm-dashboard [primary], crm-email [auxiliary], crm-meetings [auxiliary], crm-intelligence [auxiliary], marketing-crm [public], auth-full [gateway], settings-full [auxiliary])
- **Features:** pipeline, contacts, deals, ai-enrichment, forecasting, email, ai-compose, categorization, meetings, ai-recap, transcription, action-items, ai-insights, analytics, marketing, seo, auth, mfa, oauth, email-verification, password-reset, profile-edit, password-change, mfa-management, session-management, theme-toggle, account-deletion, command-palette
- **Guard mode:** strict

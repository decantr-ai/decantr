...
**Role:** public | **Shell:** top-nav-footer | **Archetype:** marketing-crm
**Description:** Public marketing landing page for the AI-native CRM. Showcases AI-powered sales features, pipeline management, pricing, and customer testimonials with strong conversion CTAs.
...
**Pages:** 1 (home)
**Key patterns:** hero, features, testimonials [moderate], pricing [moderate], cta-section
...
Layout: hero → features → testimonials → pricing → cta-section

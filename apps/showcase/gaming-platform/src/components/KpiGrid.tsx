import { TrendingUp, TrendingDown, Users, Swords, Trophy, Target } from 'lucide-react';
...
export function KpiGrid({ stats }: { stats: GuildStat[] }) {
  return (
    <div className="d-section" data-density="compact">
      <div style={{
        ...
        {stats.map(stat => {
          ...
          return (
            <div key={stat.label} className="d-surface" style={{ padding: 'var(--d-surface-p)' }}>
              ...
              <div className="gg-stat-pulse" style={{ fontSize: '1.5rem', fontWeight: 600, marginBottom: '0.25rem' }}>
                {stat.value}
              </div>
              <span

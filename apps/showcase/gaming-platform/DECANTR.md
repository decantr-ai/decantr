...
- **Sections:** 4 (gaming-community [auxiliary], game-catalog [primary], auth-flow [gateway], settings [auxiliary])
- **Features:** guild-state, achievements, realtime-data, search, auth, notifications
- **Guard mode:** strict

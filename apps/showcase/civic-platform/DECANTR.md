...
- **Theme:** government (light mode, sharp shape)
...
- **Sections:** 7 (engagement-hub [primary], budget-transparency [auxiliary], meeting-archive [auxiliary], service-requests [auxiliary], marketing-civic [public], auth-full [gateway], settings-full [auxiliary])
- **Features:** petitions, voting, comments, budget-transparency, drill-down, meetings, archives, service-requests, mapping, marketing, auth, mfa, oauth, email-verification, password-reset, profile-edit, password-change, mfa-management, session-management, theme-toggle, account-deletion
- **Guard mode:** strict

...
**Role:** auxiliary | **Shell:** sidebar-main | **Archetype:** prompt-library
**Description:** Version-controlled prompt library for authoring, searching, comparing, and testing prompts with full diff history and evaluation results.

## Quick Start

**Shell:** Collapsible sidebar with header bar and scrollable main content area. Used by saas-dashboard, financial-dashboard, workbench, ecommerce (account pages). (nav: 240px, header: 52px)
**Pages:** 3 (prompts, prompt-detail, prompt-compare)
...
Layout: prompt-editor → version-timeline

### prompt-compare (/prompts/compare)

Layout: prompt-diff → test-results

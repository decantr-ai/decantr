# Section: recipe-creator

**Role:** auxiliary | **Shell:** sidebar-main | **Archetype:** recipe-creator
**Description:** Recipe creation editor with sectioned forms, drag-and-drop ingredient and step ordering, and a personal recipe management table.

## Quick Start

**Shell:** Collapsible sidebar with header bar and scrollable main content area. Used by saas-dashboard, financial-dashboard, workbench, ecommerce (account pages). (nav: 240px, header: 52px)
**Pages:** 2 (create, my-recipes)
**Key patterns:** recipe-form [moderate]
...
drag-drop, image-upload, autosave, preview
...
Layout: recipe-form → ingredient-list

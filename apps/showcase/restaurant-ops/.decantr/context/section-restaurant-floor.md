# Section: restaurant-floor

**Role:** primary | **Shell:** sidebar-main | **Archetype:** restaurant-floor
**Description:** Live floor map and reservations workspace for front-of-house staff. Real-time table status, reservation calendar, and guest seating.

## Quick Start

**Shell:** Collapsible sidebar with header bar and scrollable main content area. Used by saas-dashboard, financial-dashboard, workbench, ecommerce (account pages). (nav: 240px, header: 52px)
**Pages:** 3 (floor, reservations, new-reservation)
**Key patterns:** reservation-form [moderate]
...
**Preferred:** reservation-calendar
...
floor-map, reservations, walk-ins
...
Layout: floor-kpis → floor-map → floor-activity

### reservations (/floor/reservations)

Layout: reservation-calendar → reservation-list

### new-reservation (/floor/reservations/new)

Layout: reservation-form → table-picker

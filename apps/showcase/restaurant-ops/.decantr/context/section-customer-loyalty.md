...
**Role:** auxiliary | **Shell:** sidebar-main | **Archetype:** customer-loyalty
**Description:** Customer relationship and loyalty program management. Tracks guest history, preferences, tier status, and rewards.

## Quick Start

**Shell:** Collapsible sidebar with header bar and scrollable main content area. Used by saas-dashboard, financial-dashboard, workbench, ecommerce (account pages). (nav: 240px, header: 52px)
**Pages:** 3 (customers, customer-detail, loyalty-program)
**Key patterns:** visit-history
...
Layout: customer-filters → customer-list

### customer-detail (/customers/:id)

Layout: customer-header → visit-history → relationship-timeline

### loyalty-program (/customers/loyalty)

Layout: loyalty-kpis → tiers

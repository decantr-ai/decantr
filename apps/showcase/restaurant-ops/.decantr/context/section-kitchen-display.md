...
**Role:** auxiliary | **Shell:** sidebar-main | **Archetype:** kitchen-display
**Description:** Kitchen display system (KDS) for restaurant ticket routing. Horizontal ticket rail with station-specific views and fire timers.

## Quick Start

**Shell:** Collapsible sidebar with header bar and scrollable main content area. Used by saas-dashboard, financial-dashboard, workbench, ecommerce (account pages). (nav: 240px, header: 52px)
**Pages:** 2 (kitchen, stations)
...
Layout: kitchen-kpis → ticket-rail

### stations (/kitchen/stations)

Layout: station-tickets

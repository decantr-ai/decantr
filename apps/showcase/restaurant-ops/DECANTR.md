...
- **Theme:** bistro (light mode, rounded shape)
...
- **Sections:** 10 (restaurant-floor [primary], kitchen-display [auxiliary], menu-management [auxiliary], inventory-supplies [auxiliary], server-station [auxiliary], customer-loyalty [auxiliary], daily-operations [auxiliary], marketing-restaurant [public], auth-full [gateway], settings-full [auxiliary])
- **Features:** floor-map, reservations, walk-ins, kds, tickets, station-routing, menu-editing, engineering, inventory, purchasing, shifts, tips, loyalty, customer-tracking, operations, reports, pnl, marketing, auth, mfa, oauth, email-verification, password-reset, profile-edit, password-change, mfa-management, session-management, theme-toggle, account-deletion
- **Guard mode:** strict

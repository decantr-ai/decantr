...
**Role:** auxiliary | **Shell:** sidebar-main | **Archetype:** character-library
**Description:** Manage reusable AI character references with persistent identity, appearance details, and consistency tracking across video scenes.

## Quick Start

**Shell:** Collapsible sidebar with header bar and scrollable main content area. Used by saas-dashboard, financial-dashboard, workbench, ecommerce (account pages). (nav: 240px, header: 52px)
**Pages:** 2 (characters, character-detail)
...
character-tracking, consistency
...
Layout: filters → character-cards

### character-detail (/characters/:id)

Layout: full-sheet → appearances

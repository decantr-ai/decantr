...
- **Sections:** 6 (content-reader [primary], content-author [auxiliary], content-newsletter [auxiliary], marketing-content [public], auth-flow [gateway], settings [auxiliary])
- **Features:** search, reading, rss, bookmarks, editing, publishing, auto-save, markdown, subscription, email, marketing, seo, auth, theme-toggle
- **Guard mode:** strict

...
- **Sections:** 5 (cloud-marketing [public], cloud-infrastructure [primary], billing [auxiliary], auth-flow [gateway], settings [auxiliary])
- **Features:** realtime-data, team-management, billing, auth, search
- **Guard mode:** strict

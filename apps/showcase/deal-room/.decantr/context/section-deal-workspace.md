...
**Role:** primary | **Shell:** sidebar-main | **Archetype:** deal-workspace
**Description:** Private equity deal workspace with dashboard, stage gate tracking, and per-stage detail views. Core interface for managing active M&A and investment transactions through structured stage progression.

## Quick Start

**Shell:** Collapsible sidebar with header bar and scrollable main content area. Used by saas-dashboard, financial-dashboard, workbench, ecommerce (account pages). (nav: 240px, header: 52px)
**Pages:** 2 (overview, stage-detail)
...
Layout: deal-metrics → stage-progress → deal-activity

### stage-detail (/deal/stages/:id)

Layout: stage-timeline → stage-requirements

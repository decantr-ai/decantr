...
- **Blueprint:** deal-room
- **Theme:** bespoke (dark mode, rounded shape)
...
- **Sections:** 7 (deal-workspace [primary], document-vault [auxiliary], qa-workflow [auxiliary], investor-portal [auxiliary], marketing-deal-room [public], auth-full [gateway], settings-full [auxiliary])
- **Features:** deal-tracking, stage-gates, secure-documents, watermarks, audit, qa, assignments, investor-management, nda-tracking, marketing, auth, mfa, oauth, email-verification, password-reset, profile-edit, password-change, mfa-management, session-management, theme-toggle, account-deletion
- **Guard mode:** strict

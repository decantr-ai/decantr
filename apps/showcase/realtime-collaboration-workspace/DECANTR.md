...
- **Theme:** paper (light mode, rounded shape)
...
- **Sections:** 9 (workspace-home [primary], document-editor [primary], workspace-settings [auxiliary], auth-full [gateway], settings-full [auxiliary], marketing-productivity [public], about-hybrid [public], contact [public], legal [public])
- **Features:** realtime, search, favorites, recent-history, presence, comments, mentions, versioning, sharing, export, markdown, slash-commands, team-management, permissions, billing, admin, auth, mfa, oauth, email-verification, password-reset, profile-edit, password-change, mfa-management, session-management, theme-toggle, account-deletion, marketing, pricing, testimonials, cta, team-grid, values-display, form-validation, spam-protection, file-attachment, toc-navigation, print-friendly, smooth-scroll
- **Guard mode:** strict

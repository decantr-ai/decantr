...
- `release-waiver.json` authorizes stable 3.9.3 publication by the sole human maintainer while leaving the exact four human finding requirements missing and every qualification/adoption claim false.

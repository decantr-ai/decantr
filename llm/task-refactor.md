...
> Read this file when refactoring code, fixing style drift, or correcting essence violations.
...
Run `npx decantr validate` to check the Essence against the schema. Common violations:
...
- Patterns MUST be abstract from recipes and archetypes
...
- Recipes and styles are fully abstracted plugins
...
- ALWAYS consult `reference/atoms.md` or the atom reference in this file before generating markup

...
The public registry portal and marketplace are retired. This is a stable 3.x compatibility package, not an active product foundation. Decantr 3.11 assigns this package no feature investment. Do not use registry search volume, compatibility aliases, or corpus size as evidence that Decantr improves an AI coding agent. Removal or consolidation requires the published 4.0 entry and migration gates; Decantr 3.x compatibility remains intact.

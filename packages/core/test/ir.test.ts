  ...
  return {
    ...
    presets: {
      default: {
        ...
        layout: { layout: 'column', atoms: '_flex _col _gap4' },
        code: {
...
describe('buildPageIR', () => {
  it('converts string layout items to IRPatternNode', () => {
  ...
  it('converts PatternRef layout items with alias', () => {
    ...
    const heroPattern = makePattern('hero', {
      presets: {
        default: {
          ...
          layout: { layout: 'hero', atoms: '_flex _col _aic' },
          code: { imports: '', example: 'function Hero() {}' },
        },
      },
    });
    const heroPreset = makeResolvedPreset({ layout: { layout: 'hero', atoms: '_flex _col _aic' } });

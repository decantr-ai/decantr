...
"neon". This would violate the Style guard rule.

Would you like me to:
1. Update the essence to use "glassmorphism" instead?
2. Keep the current theme "neon"?
```
...
- [ ] I know the exact layout order: `[object Object], kpi-grid, [object Object]`
- [ ] I will use theme: `neon`
- [ ] I will use recipe: `neon`
...
|-----------|---------------|-----|
| "Theme mismatch" | Used different theme | Revert to `neon` |
...
| "Recipe mismatch" | Wrong decoration style | Use `neon` |

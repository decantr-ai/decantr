...
const BASE_CSS = [
  ...
  // SELECT
  // ═══════════════════════════════════════════════════════════════
  '.d-select-wrap{position:relative;display:inline-flex;flex-direction:column;min-width:160px}',
  ...
  '.d-select-dropdown{position:absolute;top:100%;left:0;right:0;z-index:var(--d-z-dropdown);max-height:var(--d-panel-max-h);overflow:auto;margin-top:var(--d-offset-dropdown);padding:var(--d-sp-1);min-width:100%;width:max-content}',
  ...
  'dialog.d-modal-content::backdrop{background:var(--d-overlay);-webkit-backdrop-filter:blur(4px);backdrop-filter:blur(4px)}',
  ...
  '.d-dropdown-block{display:flex;width:100%}',
  '.d-dropdown-block>.d-dropdown-trigger,.d-dropdown-block>button,.d-dropdown-block>[class]{width:100%}',
  '.d-dropdown-menu{position:absolute;top:100%;left:0;z-index:var(--d-z-dropdown);min-width:180px;margin-top:var(--d-offset-menu);overflow:auto;max-height:var(--d-panel-max-h);padding:var(--d-sp-1);outline:none}',
  ...
  '.d-command-input-wrap,.d-command-search{display:flex;align-items:center;padding:var(--d-sp-2) var(--d-sp-3);gap:var(--d-sp-2)}',
  ...
  '.d-command-item-icon{display:inline-flex;align-items:center;justify-content:center;flex-shrink:0;width:1em;height:1em}',
  ...
  '.d-tabs-panel{padding:var(--d-sp-6) var(--d-sp-4) var(--d-sp-4);animation:d-fadein var(--d-duration-fast) var(--d-easing-decelerate)}',
  ...
  // SEGMENTED CONTROL
  // ═══════════════════════════════════════════════════════════════
  '.d-segmented{display:inline-flex;padding:var(--d-sp-1);border-radius:var(--d-radius-panel);gap:var(--d-sp-0-5)}',
  ...
  '@keyframes d-toast-progress{from{transform:scaleX(1)}to{transform:scaleX(0)}}',
  '.d-toast-progress{position:absolute;bottom:0;left:0;right:0;height:2px;background:currentColor;opacity:0.3;transform-origin:left;animation:d-toast-progress linear both}',
  '.d-toast{position:relative;overflow:hidden}',
  ...
  '.d-statistic-trend-up{color:var(--d-success)}',
  '.d-statistic-trend-down{color:var(--d-error)}',
...
'.d-timerange-error:empty{display:none}',
  ...
  // Core wrapper elements (custom elements default to display:inline)
  ...
  // ═══════════════════════════════════════════════════════════════
  '.d-shell{display:grid;height:100vh;width:100%;transition:grid-template-columns var(--d-duration-normal,200ms) var(--d-easing-standard,ease)}',
  '.d-shell-header{grid-area:header;display:flex;align-items:center;gap:var(--d-sp-4);padding:0 var(--d-sp-6);min-height:var(--d-shell-header-h,52px);z-index:var(--d-z-sticky,1100);overflow:visible}',
  ...
  '.d-shell-body{grid-area:body;overflow:auto;display:flex;flex-direction:column;min-height:0;outline:none}',
  ...
  // STAGGER ANIMATION
  // ═══════════════════════════════════════════════════════════════
  '.d-stagger>*{animation:d-fadein var(--d-duration-normal) var(--d-easing-decelerate) both}',
  '.d-stagger>:nth-child(1){animation-delay:0ms}',
  '.d-stagger>:nth-child(2){animation-delay:50ms}',
  '.d-stagger>:nth-child(3){animation-delay:100ms}',
  '.d-stagger>:nth-child(4){animation-delay:150ms}',
  '.d-stagger>:nth-child(5){animation-delay:200ms}',
  '.d-stagger>:nth-child(6){animation-delay:250ms}',
  '.d-stagger>:nth-child(7){animation-delay:300ms}',
  '.d-stagger>:nth-child(8){animation-delay:350ms}',
  '.d-stagger>:nth-child(n+9){animation-delay:400ms}',
  '.d-stagger-up>*{animation:d-slidein-b var(--d-duration-normal) var(--d-easing-decelerate) both}',
  '.d-stagger-up>:nth-child(1){animation-delay:0ms}',
  '.d-stagger-up>:nth-child(2){animation-delay:50ms}',
  '.d-stagger-up>:nth-child(3){animation-delay:100ms}',
  '.d-stagger-up>:nth-child(4){animation-delay:150ms}',
  '.d-stagger-up>:nth-child(5){animation-delay:200ms}',
  '.d-stagger-up>:nth-child(6){animation-delay:250ms}',
  '.d-stagger-up>:nth-child(7){animation-delay:300ms}',
  '.d-stagger-up>:nth-child(8){animation-delay:350ms}',
  '.d-stagger-up>:nth-child(n+9){animation-delay:400ms}',
  '.d-stagger-scale>*{animation:d-scalein var(--d-duration-normal) var(--d-easing-decelerate) both}',
  '.d-stagger-scale>:nth-child(1){animation-delay:0ms}',
  '.d-stagger-scale>:nth-child(2){animation-delay:50ms}',
  '.d-stagger-scale>:nth-child(3){animation-delay:100ms}',
  '.d-stagger-scale>:nth-child(4){animation-delay:150ms}',
  '.d-stagger-scale>:nth-child(5){animation-delay:200ms}',
  '.d-stagger-scale>:nth-child(6){animation-delay:250ms}',
  '.d-stagger-scale>:nth-child(7){animation-delay:300ms}',
  '.d-stagger-scale>:nth-child(8){animation-delay:350ms}',
  '.d-stagger-scale>:nth-child(n+9){animation-delay:400ms}',
  ...
  // MARQUEE
  // ═══════════════════════════════════════════════════════════════
  '.d-marquee-wrap{overflow:hidden;width:100%}',
  '.d-marquee-segment{display:flex;flex-shrink:0;gap:var(--d-marquee-gap,var(--d-sp-8))}',
  '@keyframes d-marquee{from{transform:translateX(0)}to{transform:translateX(-50%)}}',
  '.d-marquee{display:flex;width:max-content;animation:d-marquee var(--d-marquee-duration,30s) linear infinite}',
  '.d-marquee:hover{animation-play-state:paused}',
  '.d-marquee-reverse{animation-direction:reverse}',
  '@media(prefers-reduced-motion:reduce){.d-marquee{animation:none}}',

  // ═══════════════════════════════════════════════════════════════
  // SCROLL REVEAL
  // ═══════════════════════════════════════════════════════════════
  '.d-reveal{opacity:0;transform:translateY(20px);transition:opacity 0.6s ease,transform 0.6s ease}',
  '.d-reveal.d-visible{opacity:1;transform:translateY(0)}',
  '@media(prefers-reduced-motion:reduce){.d-reveal{opacity:1;transform:none;transition:none}}',

  // ═══════════════════════════════════════════════════════════════
  // DECORATIVE ANIMATIONS
  // ═══════════════════════════════════════════════════════════════
  '@keyframes d-float{0%,100%{transform:translateY(0)}50%{transform:translateY(-10px)}}',
  '.d-float{animation:d-float 6s ease-in-out infinite}',
  '@keyframes d-glow-pulse-kf{0%,100%{box-shadow:0 0 15px rgba(254,68,116,0.2)}50%{box-shadow:0 0 30px rgba(254,68,116,0.4)}}',
  '.d-glow-pulse{animation:d-glow-pulse-kf 3s ease-in-out infinite}',
  '.d-stagger>*{animation-delay:calc(var(--d-i,0) * 0.1s)}',
  '@media(prefers-reduced-motion:reduce){.d-float,.d-glow-pulse{animation:none}}',

  // ═══════════════════════════════════════════════════════════════
  // DISPLAY HEADING
  // ═══════════════════════════════════════════════════════════════
  '.d-heading-display{font-size:clamp(2.5rem,6vw,5rem);font-weight:800;letter-spacing:-0.03em;line-height:1.05}',

  // ═══════════════════════════════════════════════════════════════
  // SYNTAX HIGHLIGHT TOKENS
  // ═══════════════════════════════════════════════════════════════
  '.d-hl-keyword{color:var(--d-primary)}',
  '.d-hl-string{color:var(--d-success)}',
  '.d-hl-comment{color:var(--d-muted);font-style:italic}',
  '.d-hl-number{color:var(--d-accent)}',
  '.d-hl-function{color:var(--d-info)}',
  '.d-hl-operator{color:var(--d-warning)}',
  '.d-hl-punctuation{color:var(--d-muted-fg)}',

  // ═══════════════════════════════════════════════════════════════
  // BROWSER FRAME
  // ═══════════════════════════════════════════════════════════════
  '.d-browser-frame{border-radius:var(--d-radius-lg);overflow:hidden;border:var(--d-border-width) solid var(--d-border)}',
  '.d-browser-frame-bar{display:flex;align-items:center;gap:var(--d-sp-2);padding:var(--d-sp-2) var(--d-sp-3);background:var(--d-surface-1)}',
  '.d-browser-frame-dots{display:flex;gap:var(--d-sp-1-5)}',
  '.d-browser-frame-dot{width:10px;height:10px;border-radius:50%;background:var(--d-muted)}',
  '.d-browser-frame-dot:first-child{background:var(--d-error)}',
  '.d-browser-frame-dot:nth-child(2){background:var(--d-warning)}',
  '.d-browser-frame-dot:nth-child(3){background:var(--d-success)}',
  '.d-browser-frame-url{flex:1;font-size:var(--d-text-xs);color:var(--d-muted);padding:var(--d-sp-1) var(--d-sp-2);background:var(--d-surface-0);border-radius:var(--d-radius-inner);overflow:hidden;text-overflow:ellipsis;white-space:nowrap}',
  '.d-browser-frame-body{background:var(--d-surface-0)}'
].join('');

...
export async function build(options) {
  ...
  const { entry, outDir, projectRoot, minify = true, sourceMaps = true, validate: doValidate = true, dev = false, lint = {} } = options;
  ...
  try {
    ...
    const transforms = createPipeline({ dev, minify, lint });

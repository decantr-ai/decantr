      ...
      findings: [
        {
          ...
          graph: {
            ...
            route: '/settings',
            confidence: 'inferred',
            reason: 'finding text matched a Route node',
          },
          repair: {
            id: 'reconcile-brownfield-routes',
            payload: {
              source: 'brownfield',
              rule: 'brownfield-route-drift',
            },
          ...
          repairPlan: {
            id: 'repair-plan:brownfield-route-drift',
            findingId: 'brownfield-route-drift',
            diagnosticCode: 'ROUTE001',
            ...
            actions: [
              {
                ...
                kind: 'manual_repair',
                target: null,
                description: 'Regenerate a brownfield proposal.',
                payload: {
                  source: 'brownfield',
                  rule: 'brownfield-route-drift',
                },
            ...
            evidence: [
              {
                id: 'evidence:brownfield-route-drift:1',
                text: 'Route: /settings',
              },
            ],
            readTargets: [
            ...
            preserve: ['existing framework, routing, and styling system'],
            avoid: ['rewriting unrelated routes'],
    ...
    const bundle = {
      ...
      provenance: {
        ...
        graphSnapshot: {
          ...
          present: true,
          hash: '5e2d5d3f6a3f2c1b',
          generatedAt: '2026-05-12T14:00:00.000Z',
        },
        graphManifest: {
          path: '.decantr/graph/graph.manifest.json',
          present: true,
          hash: '4e2d5d3f6a3f2c1b',
          generatedAt: '2026-05-12T14:00:00.000Z',
        },
        graphDiff: {
          path: '.decantr/graph/graph.diff.json',
          present: true,
          hash: '3e2d5d3f6a3f2c1b',
          generatedAt: '2026-05-12T14:00:00.000Z',
        },
        contractCapsule: {
          path: '.decantr/graph/contract-capsule.json',
          present: true,
          hash: '2e2d5d3f6a3f2c1b',
          generatedAt: '2026-05-12T14:00:00.000Z',
        },
      },
      assertions: [
      ...
      findings: [
        {
          ...
          graph: {
            ...
            node_type: 'Project',
            confidence: 'fallback',
            reason: 'finding is project-level or no specific graph node matched',
          },
          repair: {
            id: 'hydrate-execution-packs',
            payload: {
              source: 'assertion',
              rule: 'pack-manifest-present',
            },
          ...
          repairPlan: {
            id: 'repair-plan:assertion-contract-context-pack-manifest',
            findingId: 'assertion-contract-context-pack-manifest',
            diagnosticCode: 'CTX002',
            ...
            actions: [
              {
                id: 'hydrate-execution-packs',
                kind: 'manual_repair',
                target: '.decantr/context/pack-manifest.json',
                description: 'Run `decantr refresh`.',
                payload: {
                  source: 'assertion',
                  rule: 'pack-manifest-present',
                },
            ...
            evidence: [
              {
                id: 'evidence:assertion-contract-context-pack-manifest:1',
                text: '.decantr/context/pack-manifest.json',
              },
            ],
            readTargets: [
              'DECANTR.md',

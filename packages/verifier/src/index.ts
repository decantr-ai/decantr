...
function isLocationObjectExpression(expression: ts.Expression): boolean {
  return (
    ...
    || (
      ...
      && ['window', 'globalThis', 'document'].includes(expression.expression.text)
...
function countAuthProtectedLoadingRenderSignals(code: string): number {
  const patterns = [
    ...
    /\bif\s*\(\s*[^)]*(?:status\s*===?\s*['"`]loading['"`]|isLoading|loading|isPending|pending|sessionLoading|authLoading)[^)]*\)\s*{[\s\S]{0,320}?return\s*<[\w.:-]+[^>]*=\s*{\s*\[[\s\S]{0,220}?\bpayload\s*:\s*JSON\.stringify\(\s*{[^}]*\b(?:label|title|subtitle|description|value|content|name|email|avatar|src)\s*:\s*[^,\]}]*\b(?:session|user|currentUser|currentSession|authUser|viewer|profile|account|member)\b[^,\]}]*[^}]*}\s*\)[\s\S]{0,220}?\]\s*}[^>]*>/gi,
    /\bif\s*\(\s*[^)]*(?:status\s*===?\s*['"`]loading['"`]|isLoading|loading|isPending|pending|sessionLoading|authLoading)[^)]*\)\s*return\s*<[\w.:-]+[^>]*=\s*{\s*\[[\s\S]{0,220}?\bpayload\s*:\s*JSON\.stringify\(\s*{[^}]*\b(?:label|title|subtitle|description|value|content|name|email|avatar|src)\s*:\s*[^,\]}]*\b(?:session|user|currentUser|currentSession|authUser|viewer|profile|account|member)\b[^,\]}]*[^}]*}\s*\)[\s\S]{0,220}?\]\s*}[^>]*>/gi,
    ...
    /\bif\s*\(\s*[^)]*(?:status\s*===?\s*['"`]loading['"`]|isLoading|loading|isPending|pending|sessionLoading|authLoading)[^)]*\)\s*{[\s\S]{0,320}?return\s*<[\w.:-]+[^>]*=\s*{\s*\[[\s\S]{0,220}?\bpayload\s*:\s*(?:new\s+)?URLSearchParams\(\s*{[^}]*\b(?:label|title|subtitle|description|value|content|name|email|avatar|src)\s*:\s*[^,\]}]*\b(?:session|user|currentUser|currentSession|authUser|viewer|profile|account|member)\b[^,\]}]*[^}]*}\s*\)(?:\.toString\(\s*\))?[\s\S]{0,220}?\]\s*}[^>]*>/gi,
    /\bif\s*\(\s*[^)]*(?:status\s*===?\s*['"`]loading['"`]|isLoading|loading|isPending|pending|sessionLoading|authLoading)[^)]*\)\s*return\s*<[\w.:-]+[^>]*=\s*{\s*\[[\s\S]{0,220}?\bpayload\s*:\s*(?:new\s+)?URLSearchParams\(\s*{[^}]*\b(?:label|title|subtitle|description|value|content|name|email|avatar|src)\s*:\s*[^,\]}]*\b(?:session|user|currentUser|currentSession|authUser|viewer|profile|account|member)\b[^,\]}]*[^}]*}\s*\)(?:\.toString\(\s*\))?[\s\S]{0,220}?\]\s*}[^>]*>/gi,
    ...
    /\bif\s*\(\s*[^)]*(?:status\s*===?\s*['"`]loading['"`]|isLoading|loading|isPending|pending|sessionLoading|authLoading)[^)]*\)\s*{[\s\S]{0,320}?return\s*<[\w.:-]+[^>]*=\s*{\s*\[[\s\S]{0,220}?\bpayload\s*:\s*createSearchParams\(\s*{[^}]*\b(?:label|title|subtitle|description|value|content|name|email|avatar|src)\s*:\s*[^,\]}]*\b(?:session|user|currentUser|currentSession|authUser|viewer|profile|account|member)\b[^,\]}]*[^}]*}\s*\)(?:\.toString\(\s*\))?[\s\S]{0,220}?\]\s*}[^>]*>/gi,
    /\bif\s*\(\s*[^)]*(?:status\s*===?\s*['"`]loading['"`]|isLoading|loading|isPending|pending|sessionLoading|authLoading)[^)]*\)\s*return\s*<[\w.:-]+[^>]*=\s*{\s*\[[\s\S]{0,220}?\bpayload\s*:\s*createSearchParams\(\s*{[^}]*\b(?:label|title|subtitle|description|value|content|name|email|avatar|src)\s*:\s*[^,\]}]*\b(?:session|user|currentUser|currentSession|authUser|viewer|profile|account|member)\b[^,\]}]*[^}]*}\s*\)(?:\.toString\(\s*\))?[\s\S]{0,220}?\]\s*}[^>]*>/gi,
    ...
    /\bif\s*\(\s*[^)]*(?:status\s*===?\s*['"`]loading['"`]|isLoading|loading|isPending|pending|sessionLoading|authLoading)[^)]*\)\s*{[\s\S]{0,320}?return\s*<[\w.:-]+[^>]*=\s*{\s*\[[\s\S]{0,220}?\b(?:state|options|config|meta|details|data)\s*:\s*{[^}]*\b(?:label|title|subtitle|description|value|content|name|email|avatar|src)\s*:\s*[^,\]}]*\b(?:session|user|currentUser|currentSession|authUser|viewer|profile|account|member)\b[^,\]}]*[^}]*}[\s\S]{0,220}?\]\s*}[^>]*>/gi,
    /\bif\s*\(\s*[^)]*(?:status\s*===?\s*['"`]loading['"`]|isLoading|loading|isPending|pending|sessionLoading|authLoading)[^)]*\)\s*return\s*<[\w.:-]+[^>]*=\s*{\s*\[[\s\S]{0,220}?\b(?:state|options|config|meta|details|data)\s*:\s*{[^}]*\b(?:label|title|subtitle|description|value|content|name|email|avatar|src)\s*:\s*[^,\]}]*\b(?:session|user|currentUser|currentSession|authUser|viewer|profile|account|member)\b[^,\]}]*[^}]*}[\s\S]{0,220}?\]\s*}[^>]*>/gi,
...
function countAuthProtectedUnauthenticatedRenderSignals(code: string): number {
  const patterns = [
    ...
    /\bif\s*\(\s*(?:!\s*(?:session|user|currentUser|currentSession|authUser)|(?:session|user|currentUser|currentSession|authUser)\s*(?:==|===)\s*(?:null|undefined)|status\s*===?\s*['"`]unauthenticated['"`]|status\s*!==?\s*['"`]authenticated['"`])\s*\)\s*{[\s\S]{0,320}?return\s*<[\w.:-]+[^>]*=\s*{\s*JSON\.stringify\(\s*{[^}]*\b(?:label|title|subtitle|description|value|content|name|email|avatar|src)\s*:\s*[^,\]}]*\b(?:session|user|currentUser|currentSession|authUser|viewer|profile|account|member)\b[^,\]}]*[^}]*}\s*\)\s*}[^>]*>/gi,
    /\bif\s*\(\s*(?:!\s*(?:session|user|currentUser|currentSession|authUser)|(?:session|user|currentUser|currentSession|authUser)\s*(?:==|===)\s*(?:null|undefined)|status\s*===?\s*['"`]unauthenticated['"`]|status\s*!==?\s*['"`]authenticated['"`])\s*\)\s*return\s*<[\w.:-]+[^>]*=\s*{\s*JSON\.stringify\(\s*{[^}]*\b(?:label|title|subtitle|description|value|content|name|email|avatar|src)\s*:\s*[^,\]}]*\b(?:session|user|currentUser|currentSession|authUser|viewer|profile|account|member)\b[^,\]}]*[^}]*}\s*\)\s*}[^>]*>/gi,
    ...
    /\bif\s*\(\s*(?:!\s*(?:session|user|currentUser|currentSession|authUser)|(?:session|user|currentUser|currentSession|authUser)\s*(?:==|===)\s*(?:null|undefined)|status\s*===?\s*['"`]unauthenticated['"`]|status\s*!==?\s*['"`]authenticated['"`])\s*\)\s*{[\s\S]{0,320}?return\s*<[\w.:-]+[^>]*=\s*{\s*(?:new\s+)?URLSearchParams\(\s*{[^}]*\b(?:label|title|subtitle|description|value|content|name|email|avatar|src)\s*:\s*[^,\]}]*\b(?:session|user|currentUser|currentSession|authUser|viewer|profile|account|member)\b[^,\]}]*[^}]*}\s*\)(?:\.toString\(\s*\))?\s*}[^>]*>/gi,
    /\bif\s*\(\s*(?:!\s*(?:session|user|currentUser|currentSession|authUser)|(?:session|user|currentUser|currentSession|authUser)\s*(?:==|===)\s*(?:null|undefined)|status\s*===?\s*['"`]unauthenticated['"`]|status\s*!==?\s*['"`]authenticated['"`])\s*\)\s*return\s*<[\w.:-]+[^>]*=\s*{\s*(?:new\s+)?URLSearchParams\(\s*{[^}]*\b(?:label|title|subtitle|description|value|content|name|email|avatar|src)\s*:\s*[^,\]}]*\b(?:session|user|currentUser|currentSession|authUser|viewer|profile|account|member)\b[^,\]}]*[^}]*}\s*\)(?:\.toString\(\s*\))?\s*}[^>]*>/gi,
    ...
    /\bif\s*\(\s*(?:!\s*(?:session|user|currentUser|currentSession|authUser)|(?:session|user|currentUser|currentSession|authUser)\s*(?:==|===)\s*(?:null|undefined)|status\s*===?\s*['"`]unauthenticated['"`]|status\s*!==?\s*['"`]authenticated['"`])\s*\)\s*{[\s\S]{0,320}?return\s*<[\w.:-]+[^>]*=\s*{\s*createSearchParams\(\s*{[^}]*\b(?:label|title|subtitle|description|value|content|name|email|avatar|src)\s*:\s*[^,\]}]*\b(?:session|user|currentUser|currentSession|authUser|viewer|profile|account|member)\b[^,\]}]*[^}]*}\s*\)(?:\.toString\(\s*\))?\s*}[^>]*>/gi,
    /\bif\s*\(\s*(?:!\s*(?:session|user|currentUser|currentSession|authUser)|(?:session|user|currentUser|currentSession|authUser)\s*(?:==|===)\s*(?:null|undefined)|status\s*===?\s*['"`]unauthenticated['"`]|status\s*!==?\s*['"`]authenticated['"`])\s*\)\s*return\s*<[\w.:-]+[^>]*=\s*{\s*createSearchParams\(\s*{[^}]*\b(?:label|title|subtitle|description|value|content|name|email|avatar|src)\s*:\s*[^,\]}]*\b(?:session|user|currentUser|currentSession|authUser|viewer|profile|account|member)\b[^,\]}]*[^}]*}\s*\)(?:\.toString\(\s*\))?\s*}[^>]*>/gi,
    ...
    /\bif\s*\(\s*(?:!\s*(?:session|user|currentUser|currentSession|authUser)|(?:session|user|currentUser|currentSession|authUser)\s*(?:==|===)\s*(?:null|undefined)|status\s*===?\s*['"`]unauthenticated['"`]|status\s*!==?\s*['"`]authenticated['"`])\s*\)\s*{[\s\S]{0,320}?return\s*<[\w.:-]+[^>]*=\s*{\s*\[[\s\S]{0,220}?\b(?:state|options|config|meta|details|data)\s*:\s*{[^}]*\b(?:label|title|subtitle|description|value|content|name|email|avatar|src)\s*:\s*[^,\]}]*\b(?:session|user|currentUser|currentSession|authUser|viewer|profile|account|member)\b[^,\]}]*[^}]*}[\s\S]{0,220}?\]\s*}[^>]*>/gi,
    /\bif\s*\(\s*(?:!\s*(?:session|user|currentUser|currentSession|authUser)|(?:session|user|currentUser|currentSession|authUser)\s*(?:==|===)\s*(?:null|undefined)|status\s*===?\s*['"`]unauthenticated['"`]|status\s*!==?\s*['"`]authenticated['"`])\s*\)\s*return\s*<[\w.:-]+[^>]*=\s*{\s*\[[\s\S]{0,220}?\b(?:state|options|config|meta|details|data)\s*:\s*{[^}]*\b(?:label|title|subtitle|description|value|content|name|email|avatar|src)\s*:\s*[^,\]}]*\b(?:session|user|currentUser|currentSession|authUser|viewer|profile|account|member)\b[^,\]}]*[^}]*}[\s\S]{0,220}?\]\s*}[^>]*>/gi,
...
const LOCATION_QUERY_SOURCE_REGEX = /\b(?:(?:window|globalThis|document)\.)?location\.(?:search|hash)(?:\.slice\(\s*1\s*\)|\.replace\([^)]*\))?\b/i;
const LOCATION_URL_INPUT_REGEX = /\b(?:(?:(?:window|globalThis|document)\.)?location\.(?:href|search|hash)|(?:request|req)\.url)\b/i;
const LOCATION_URL_SOURCE_REGEX = /\bnew\s+URL\(\s*(?:(?:(?:window|globalThis|document)\.)?location\.(?:href|search|hash)|(?:request|req)\.url)\s*\)/i;
...
function countAuthOpenRedirectSignals(code: string): number {
  const patterns = [
    ...
    new RegExp(String.raw`\b(?:window|globalThis|document)\.location(?:\.href)?\s*=\s*[^;\n]*(?:${OPEN_REDIRECT_SOURCE_PATTERN})`, 'gi'),
  ];
...
function isOpenRedirectQueryKeyExpression(
  expression: ts.Expression | undefined,
  namedExpressions: Map<string, ts.Expression> = new Map(),
  seenIdentifiers: Set<string> = new Set(),
): boolean {
  const value = getExpressionLiteralValue(expression);
  if (typeof value === 'string' && OPEN_REDIRECT_QUERY_KEY_REGEX.test(value)) {
    return true;
  }
  ...
  if (ts.isIdentifier(expression)) {
    ...
    seenIdentifiers.add(expression.text);
    const result = isOpenRedirectQueryKeyExpression(initializer, namedExpressions, seenIdentifiers);
    seenIdentifiers.delete(expression.text);
    return result;
  }
...
function expressionLooksLikeOpenRedirectQueryCarrier(
  expression: ts.Expression | undefined,
  sourceFile: ts.SourceFile,
...
function expressionLooksLikeWindowObjectSource(
  ...
  if (ts.isIdentifier(expression) && ['window', 'globalThis', 'document'].includes(expression.text)) {
    return true;
  }
...
function analyzeAstSignals(filePath: string, code: string): AstCritiqueSignals {
  ...
  const walk = (node: ts.Node) => {
    ...
    if (ts.isCallExpression(node)) {
      ...
      if (isRouteTransitionCall(node) && expressionContainsOpenRedirectSource(node.arguments[0], sourceFile, namedExpressionInitializers, namedPropertyAliases)) {
        signals.authOpenRedirectSignalCount += 1;
      }

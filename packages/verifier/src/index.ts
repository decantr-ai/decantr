...
function isPropertyLikeAccessExpression(
...
function isElementLikeAccessExpression(
  node: ts.Node | undefined,
...
type CallLikeExpression = ts.CallExpression | ts.CallChain;
...
function isMemberAccessNamed(node: ts.Node | undefined, ...names: string[]): boolean {
  if (!node) return false;
  if (isPropertyLikeAccessExpression(node)) {
    return isPropertyNamed(node.name, ...names);
  }
  if (isElementLikeAccessExpression(node)) {
...
function expressionLooksLikeHistoryObjectSource(
  expression: ts.Expression | undefined,
  sourceFile: ts.SourceFile,
  namedExpressions: Map<string, ts.Expression>,
  namedPropertyAliases: Map<string, NamedPropertyAlias>,
...
function expressionLooksLikeJsonObjectSource(
  expression: ts.Expression | undefined,
  sourceFile: ts.SourceFile,
  namedExpressions: Map<string, ts.Expression>,
  namedPropertyAliases: Map<string, NamedPropertyAlias>,
...
function expressionLooksLikeJsonParseHelper(
  expression: ts.Expression | undefined,
  sourceFile: ts.SourceFile,
  namedExpressions: Map<string, ts.Expression>,
  namedPropertyAliases: Map<string, NamedPropertyAlias>,
...
function expressionLooksLikeStructuredCloneHelper(
  expression: ts.Expression | undefined,
  sourceFile: ts.SourceFile,
  namedExpressions: Map<string, ts.Expression>,
  namedPropertyAliases: Map<string, NamedPropertyAlias>,
...
function expressionLooksLikeBrowserGlobalSymbolHelper(
  expression: ts.Expression | undefined,
  sourceFile: ts.SourceFile,
  namedExpressions: Map<string, ts.Expression>,
  namedPropertyAliases: Map<string, NamedPropertyAlias>,
...
function expressionLooksLikeBrowserGlobalBigIntHelper(
  expression: ts.Expression | undefined,
  sourceFile: ts.SourceFile,
  namedExpressions: Map<string, ts.Expression>,
  namedPropertyAliases: Map<string, NamedPropertyAlias>,
...
function expressionLooksLikeBrowserGlobalBooleanHelper(
  expression: ts.Expression | undefined,
  sourceFile: ts.SourceFile,
  namedExpressions: Map<string, ts.Expression>,
  namedPropertyAliases: Map<string, NamedPropertyAlias>,
...
function expressionLooksLikeBrowserGlobalObjectHelper(
  expression: ts.Expression | undefined,
  sourceFile: ts.SourceFile,
  namedExpressions: Map<string, ts.Expression>,
  namedPropertyAliases: Map<string, NamedPropertyAlias>,
...
function expressionLooksLikeBrowserGlobalStringHelper(
  expression: ts.Expression | undefined,
  sourceFile: ts.SourceFile,
  namedExpressions: Map<string, ts.Expression>,
  namedPropertyAliases: Map<string, NamedPropertyAlias>,
...
function expressionLooksLikeBrowserGlobalBase64Helper(
  expression: ts.Expression | undefined,
  sourceFile: ts.SourceFile,
  namedExpressions: Map<string, ts.Expression>,
  namedPropertyAliases: Map<string, NamedPropertyAlias>,
...
function expressionLooksLikeBrowserGlobalUriCodecHelper(
  expression: ts.Expression | undefined,
  sourceFile: ts.SourceFile,
  namedExpressions: Map<string, ts.Expression>,
  namedPropertyAliases: Map<string, NamedPropertyAlias>,

...
describe('evaluateGuard - v3 reads from correct paths', () => {
  ...
  it('reads guard mode from meta.guard', () => {
    const creative = makeV3({
      meta: {
        ...VALID_V3.meta,
        guard: { mode: 'creative', dna_enforcement: 'off', blueprint_enforcement: 'off' },
      },
    });
...
describe('evaluateGuard - v3 enforcement levels', () => {
  it('dna_enforcement off removes all DNA violations', () => {
    const v3 = makeV3({
      meta: {
        ...VALID_V3.meta,
        guard: { mode: 'strict', dna_enforcement: 'off', blueprint_enforcement: 'warn' },
      },
    });
  ...
  it('blueprint_enforcement off removes all blueprint violations', () => {
    const v3 = makeV3({
      meta: {
        ...VALID_V3.meta,
        guard: { mode: 'strict', dna_enforcement: 'error', blueprint_enforcement: 'off' },
      },
    });
  ...
  it('dna_enforcement warn downgrades DNA violation severity', () => {
    const v3 = makeV3({
      meta: {
        ...VALID_V3.meta,
        guard: { mode: 'strict', dna_enforcement: 'warn', blueprint_enforcement: 'warn' },
      },
    });

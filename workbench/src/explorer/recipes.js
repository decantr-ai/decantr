...
export function RecipeListView(navigateTo) {
  ...
  loadRecipes().then(recipes => {
    ...
    container.appendChild(p({ class: css('_body _fgmutedfg _mb4') }, 'Visual identity overlays — composition rules for drastic visual transformations.'));
    ...
    for (const [id, recipe] of Object.entries(recipes)) {
      grid.appendChild(div({
        ...
        p({ class: css('_caption _fgmutedfg _mt1') }, recipe.description || ''),

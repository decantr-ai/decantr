...
Current state: 2/24 development environment specs and 6/16 qualification specs are approved. The other 32 remain draft. The draft matrix deduplicates them into 26 profiles, all currently unbuilt and unverified. Therefore the matrix cannot lock, evaluator qualification cannot produce valid receipts, and run-plan generation remains closed.

...
const CURRENT_PUBLIC_RELEASE = '3.11.0';
...
if (/Development preview\s*·\s*v3\.11\b/i.test(docsIndex)) {
  failures.push('Docs homepage still labels the current 3.11 line as a development preview.');
}

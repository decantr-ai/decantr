...
export async function runAudit(options) {
  ...
  function validateHumanReviewEvidence(packet) {
    ...
    const expectedBindings = {
      ...
      replayWorkbookSha256: {
        ...
        candidate390: sha256(readFileSync(resolve(reviewRoot, 'replays', 'candidate-3.9.1.json'))),
      },
  ...
  if (packet) {
    ...
    if (!candidateArtifactSetValid) {
      error(
        'qualification-packet.json: route, finding, adoption, and machine behavior must share the exact six qualified 3.9.1 tarball hashes',
      );
    }

...
const BLOCK_CSS = [
  ...
  '.d-timeline-list::before{content:"";position:absolute;left:var(--d-sp-2);top:0;bottom:0;width:2px;background:var(--d-border)}',
  '.d-timeline-item{position:relative;padding:0 0 var(--d-sp-8) var(--d-sp-6)}',
  '.d-timeline-dot{position:absolute;left:-1.75rem;top:var(--d-sp-1);width:var(--d-sp-3);height:var(--d-sp-3);border-radius:50%;background:var(--d-primary)}',

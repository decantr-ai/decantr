...
export const glassmorphism = {
  ...
  components: [
    ...
    '.d-card-inner{border:var(--d-border-width) solid rgba(56,189,248,0.08);box-shadow:none}',
    // Modal — slightly stronger blue border
    '.d-modal-panel{border:var(--d-border-width) solid rgba(56,189,248,0.18);box-shadow:var(--d-elevation-3)}',

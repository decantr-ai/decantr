export const brutalist = {
  ...
  components: {
    button: [
      ...
      '.d-btn:hover{transform:translate(-2px,-2px);box-shadow:6px 6px 0 var(--c3)}',
      '.d-btn:active{transform:translate(2px,2px);box-shadow:1px 1px 0 var(--c3)}',
      ...
      '.d-btn-destructive:hover{background:color-mix(in srgb,var(--c9) 85%,#000)}',
      '.d-btn-ghost{background:transparent;border-color:transparent;box-shadow:none}',
      '.d-btn-ghost:hover{border-color:var(--c3);box-shadow:var(--d-shadow)}',
    ...
    card: [
      ...
      '.d-card-hover:hover{transform:translate(-2px,-2px);box-shadow:6px 6px 0 var(--c3)}',
    ...
    input: [
      ...
      '.d-input-wrap:focus-within{box-shadow:5px 5px 0 var(--c1);border-color:var(--c1)}',
    ...
    modal: [
      ...
      '.d-modal-close{background:transparent;border:2px solid var(--c3);color:var(--c3);cursor:pointer;padding:0.125rem 0.375rem;font-size:1rem;line-height:1;font-weight:800;border-radius:var(--d-radius)}',
      '.d-modal-close:hover{background:var(--c9);color:#fff;border-color:var(--c9)}',

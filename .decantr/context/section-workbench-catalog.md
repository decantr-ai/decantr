# Section: workbench-catalog

**Role:** auxiliary | **Shell:** sidebar-main | **Archetype:** workbench-catalog
**Description:** Component and pattern catalog browser for the design-system workbench. Browsable grid with instant search, detail views with JSON inspection.

## Quick Start

**Shell:** Collapsible sidebar with header bar and scrollable main content area. Used by saas-dashboard, financial-dashboard, workbench, ecommerce (account pages). (nav: 240px, header: 52px)
**Pages:** 2 (catalog, catalog-detail)
...
Layout: catalog-search → component-grid

### catalog-detail (/catalog/:id)

Layout: component-header → component-spec

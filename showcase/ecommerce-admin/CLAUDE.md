...
- `src/data/mock.js` — Mock data for products, orders, customers, inventory
...
- **Character:** professional, efficient, organized

## Pages

1. **overview** — sidebar-main: KPI grid, quick actions, chart grid + activity feed
2. **analytics** — sidebar-main: filter bar, KPI grid, chart grid, comparison panel
3. **products** — sidebar-main: KPI grid, product toolbar, data table
4. **product-detail** — sidebar-main: detail header, media gallery + form sections
5. **orders** — sidebar-main: KPI grid, kanban board
6. **order-detail** — sidebar-main: detail header, timeline + detail panel, order history
7. **customers** — sidebar-main: KPI grid, filter bar, data table
8. **customer-detail** — sidebar-main: customer header (profile preset), KPI grid, order history + activity feed
9. **inventory** — sidebar-main: KPI grid, filter bar, data table + goal tracker
10. **promotions** — sidebar-main: KPI grid, filter bar, data table
11. **media-library** — sidebar-main: file manager
12. **support** — sidebar-main: inbox
13. **store-settings** — sidebar-main: wizard
14. **login** — centered: auth form
15. **not-found** — full-bleed: 404
...
- Recipe decoration via `getRecipeDecoration()` → injects auradecantism utility classes
...
This project uses the **auradecantism** core style in **light** mode with **rounded** shape.
...
- `npx decantr dev` — Dev server with hot reload (port 4201)
